...
def parse_opt(known=False):
    # python .\train_dual.py --cache ram
    epochs = 200
    imgsz = 2560
    name = 'img2560_train0_epoch200xx'
    ...
    # parser.add_argument('--weights', type=str, default=r'D:\MJ\yolov9-main\yolov9-main\runs\train\img3520_train0_epoch200_21epochs\weights/best.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='D:\BoyangDeng\yolov9-main\models\detect\yolov9-c.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/blueberry.yaml', help='dataset.yaml path')
    ...
    # parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=2560, help='train, val image size (pixels)')
    ...
    parser.add_argument('--close-mosaic', type=int, default=50, help='Experimental')
