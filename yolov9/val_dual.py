...
def parse_opt():
    # img2560_train0_epoch200 img2560_train1_epoch173 img2560_train2_epoch162
    model_name = 'img2560_train0_epoch200'
    imgsz = 2560
    parser = argparse.ArgumentParser()
    parser.add_argument('--data', type=str, default=ROOT / 'data/blueberry.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=fr"D:\BoyangDeng\yolov9-main\runs\train\2560x2560\{model_name}\weights\best_converted.pt", help='model path(s)')
    ...
    parser.add_argument('--name', default=f'{model_name}_val', help='save to project/name')
