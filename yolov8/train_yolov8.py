...
if sys_name == "Windows":
    ...
    if target_name == 'weed2021':
        ...
        data_dir = join(config_file_dir, 'weed_stable_diffusion_controlnet.yaml')
...
if target_name == 'blueberry_dense' or target_name == 'cottonboll_dense':
    ...
    if PC_name == 'self':
        ...
        model_dirs = [
            ...
            r'D:\BoyangDeng\Detection\ultralytics_yolov8\runs\detect\train_blueberry_rep1_part1\weights'
        ]
    save_dirs = [
        './runs/detect/train_blueberry_rep1_part1',
        './runs/detect/train_blueberry_rep1_part2',
    ]
...
if target_name == 'weed_stable_diffusion_controlnet':
    ...
    save_dirs = [
        ...
        # './runs/detect/train_weed_10_species_real_plus_synthetic_3079_48epochs',
        # './runs/detect/train',
    ]
