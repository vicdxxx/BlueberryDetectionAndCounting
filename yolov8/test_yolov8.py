...
if sys_name == "Windows":
    ...
    model_dir_root = r'D:\BoyangDeng\Detection\ultralytics_yolov8\runs\detect\train_blueberry_rep1_part2'
    # model_dir_root = r'D:\BoyangDeng\Detection\ultralytics_yolov8\runs\detect\old\dense_blueberry\sample140\train2'

    # model_dir_root = r'D:\BoyangDeng\Detection\ultralytics_yolov8\runs\detect\stable_diffusion_controlnet\with_basic_data_aug\train2017_real_24epochs_640'
    if train_num <= 0:
